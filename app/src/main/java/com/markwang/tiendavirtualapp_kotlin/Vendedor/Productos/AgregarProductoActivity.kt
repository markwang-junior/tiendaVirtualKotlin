...
import com.markwang.tiendavirtualapp_kotlin.Adaptadores.AdapdadorImagenSeleccionada
...
import com.markwang.tiendavirtualapp_kotlin.databinding.ActivityAgregarProductoBinding
...
class AgregarProductoActivity : AppCompatActivity() {
    ...
    private lateinit var adaptadorImagenSel : AdapdadorImagenSeleccionada
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*Estas vistas se inicializar como ocultas*/
    ...
    private fun cargarInfo() {
        ...
        ref.child(idProducto).addListenerForSingleValueEvent(object :ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                /*Obtenidola informacion de Firebase*/
    ...
    private fun cargarImagenes() {
        adaptadorImagenSel = AdapdadorImagenSeleccionada(this, imagenSelecArrayList, idProducto)
