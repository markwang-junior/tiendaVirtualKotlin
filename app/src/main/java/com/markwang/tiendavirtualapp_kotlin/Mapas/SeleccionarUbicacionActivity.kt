package com.markwang.tiendavirtualapp_kotlin.Mapas
...
import com.markwang.tiendavirtualapp_kotlin.databinding.ActivitySeleccionarUbicacionBinding
...
class SeleccionarUbicacionActivity : AppCompatActivity() , OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.IbGps.setOnClickListener {
            if (isGpsActivated()) {
                ...
                Toast.makeText(
                    this,
                    "Laubicación no está activada, Activela para mostrar la ubicación actual.",
                    Toast.LENGTH_SHORT
                ).show()
            }
        }
    ...
    private fun addMarker(latlng : LatLng, titulo : String, direccion : String){
        ...
        try {
            ...
            markerOption.title("${titulo}")
            markerOption.snippet("$direccion")
