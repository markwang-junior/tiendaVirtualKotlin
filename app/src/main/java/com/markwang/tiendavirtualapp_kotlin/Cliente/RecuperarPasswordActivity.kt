...
import com.markwang.tiendavirtualapp_kotlin.databinding.ActivityRecuperarPasswordBinding
    ...
    private fun enviarInstrucciones() {
        ...
        firebaseAuth.sendPasswordResetEmail(email)
            .addOnSuccessListener {
                progressDialog.dismiss()
                Toast.makeText(this@RecuperarPasswordActivity, "Las instrucciones fueron enviados a su correo electrónico ", Toast.LENGTH_SHORT).show()
