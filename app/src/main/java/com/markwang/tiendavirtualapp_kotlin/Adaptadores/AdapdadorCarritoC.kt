...
import com.markwang.tiendavirtualapp_kotlin.databinding.ItemCarritoCBinding
import kotlin.math.cos

class AdapdadorCarritoC : RecyclerView.Adapter<AdapdadorCarritoC.HolderProductoCarrito> {
    ...
    private fun visualizarDescuento(modeloProductoCarrito: ModeloProductoCarrito, holder: AdapdadorCarritoC.HolderProductoCarrito) {
        if (!modeloProductoCarrito.precioDesc.equals("0")){
            holder.precioFinalPCar.text = modeloProductoCarrito.precioFinal.plus(" €")
            holder.precioOriginalPcar.text = modeloProductoCarrito.precio.plus(" €")
    ...
    private fun cargarPrimeraImg(modeloProductoCarrito: ModeloProductoCarrito, holder: AdapdadorCarritoC.HolderProductoCarrito) {
